      ...
      <RevealOnScroll>
        <div className="max-w-[620px] mx-auto text-center">
          ...
          <p className="text-white/[0.52] text-[18px] font-light leading-[1.8] mt-5">
            Whether you need a commercial appraisal report, litigation support, or MAI appraisers in Honolulu for a property tax appeal, our team is ready to deliver the expertise your project demands.
          </p>
