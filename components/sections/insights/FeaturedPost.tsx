    ...
    <section className="max-w-[1280px] mx-auto py-[80px] px-[4.5%]">
      <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-10 lg:gap-20">
          ...
          <div className="group cursor-pointer">
            <div className="aspect-[16/10] bg-navy rounded-[2px] overflow-hidden relative flex items-center justify-center">
              ...
              <div className="relative text-center px-8">
                <span className="text-gold/80 text-[11px] uppercase tracking-[0.3em] font-sans">
                  Featured Article
                </span>
        ...
        <RevealOnScroll delay={0.15}>
          <div>
            <h3 className="font-sans font-medium text-[11px] uppercase tracking-[0.25em] text-slate-light mb-6 pb-3 border-b border-gold/20">
              Recent Articles
            </h3>
            {sidebar.map((post, i) => (
              <div
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] uppercase tracking-[0.12em] font-sans text-slate-light/70">
                    {post.category}
                  </span>
                </div>
