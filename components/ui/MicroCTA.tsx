...
export default function MicroCTA({ href, children, variant = 'dark', className = '' }: MicroCTAProps) {
  ...
  return (
    <Link
      href={href}
      className={`text-[11.5px] font-sans font-medium tracking-[0.13em] uppercase inline-flex items-center border-b pb-0.5 transition-all duration-300 ${variantStyles[variant]} ${className}`}
